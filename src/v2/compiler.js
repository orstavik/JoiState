...
export function parseParam(p) {
  //primitives
  if (p === '') return undefined;//todo what should we do here?   //todo should this be the global object? or should maybe "*" be the global object.
